...
#let motor-base(uid, name, node, current: "dc", magnet: false, ..params) = {
...
#let dcmotor(name, node, ..params) = motor-base("dcmotor", name, node, current: "dc", ..params)
#let acmotor(name, node, ..params) = motor-base("acmotor", name, node, current: "ac", ..params)
